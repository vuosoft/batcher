...
class TestBatcher(unittest.TestCase):
    ...
    def test_splitting1(self):
        response = main.batcher(self.records1, TEST_SMALL_MAX_RECORD_SIZE, TEST_SMALL_MAX_BATCH_SIZE, TEST_SMALL_MAX_RECORDS_IN_BATCH)
    ...
    def test_utf1(self):
        response = main.batcher([u'\u0041\u0041\u0041\u0041\u0041', u'\u0041\u0041'], TEST_SMALL_MAX_RECORD_SIZE, TEST_SMALL_MAX_BATCH_SIZE, TEST_SMALL_MAX_RECORDS_IN_BATCH)
        #[['AAAAA', 'AA']]
        self.assertEqual(len(response), 1, "Should be 1")

    def test_utf2(self):
        response = main.batcher([u'\u03c0\u03c0\u03c0\u03c0\u03c0', u'\u03c0\u03c0'], TEST_SMALL_MAX_RECORD_SIZE, TEST_SMALL_MAX_BATCH_SIZE, TEST_SMALL_MAX_RECORDS_IN_BATCH)
        #[['ππ']]
        self.assertEqual(len(response), 1, "Should be 1")

    def test_utf3(self):
        response = main.batcher([u'\u03c0\u03c0\u03c0\u03c0', u'\u03c0\u03c0'], TEST_SMALL_MAX_RECORD_SIZE, TEST_SMALL_MAX_BATCH_SIZE, TEST_SMALL_MAX_RECORDS_IN_BATCH)
        #[['ππππ', 'ππ']]
